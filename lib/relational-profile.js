    ...
    const record = await prisma.$transaction(async (tx) => {
      ...
      return tx.memberProfile.create({
        data: {
          ...
          fatherName: nullable(source.fatherName), fatherStatus: nullable(source.fatherStatus), fatherOccupation: nullable(source.fatherOccupation),
          motherName: nullable(source.motherName), motherStatus: nullable(source.motherStatus), motherOccupation: nullable(source.motherOccupation),
          familyType: nullable(source.familyType), familyLocation: nullable(source.familyLocation), familyValues: nullable(source.familyValues),
          brothersDetails: nullable(source.brothersDetails), sistersDetails: nullable(source.sistersDetails),
