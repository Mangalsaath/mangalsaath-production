...
export const ADMIN_PERMISSIONS = Object.freeze({
  ...
  DEMO_PROFILES_READ: "demo_profiles.read",
  DEMO_PROFILES_WRITE: "demo_profiles.write"
});

const ALL_PERMISSIONS = Object.freeze(Object.values(ADMIN_PERMISSIONS));
const STANDARD_ADMIN_PERMISSIONS = Object.freeze(
  ALL_PERMISSIONS.filter((permission) => !permission.startsWith("demo_profiles.")),
);
const ROLE_PERMISSIONS = Object.freeze({
  admin: STANDARD_ADMIN_PERMISSIONS,
