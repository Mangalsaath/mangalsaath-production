...
export async function POST(request) {
  ...
  try {
    ...
    const profileData = {
      ...
      fatherName: optionalText(body.fatherName, 180),
      fatherStatus: optionalText(body.fatherStatus, 60),
      fatherOccupation: optionalText(body.fatherOccupation, 180),
      motherName: optionalText(body.motherName, 180),
      motherStatus: optionalText(body.motherStatus, 60),
      motherOccupation: optionalText(body.motherOccupation, 180),
      familyType: optionalText(body.familyType, 80),
      familyLocation: optionalText(body.familyLocation, 180),
      familyValues: optionalText(body.familyValues, 120),
      brothersDetails: optionalText(body.brothersDetails, 1500),
      sistersDetails: optionalText(body.sistersDetails, 1500),
